  ...
  sections: [
    {
      ...
      items: [
        {
          summary1: 'Artificial',
          summary2: 'Head of Design',
          summary3: 'Digital orchestration for lab automation',
          dates: 'Aug 2023 – Present',
          bullets: [
            'Doubled inbound leads by refining company vision, story, and marketing materials.',
            'Increased product velocity by 50% by establishing robust product development process.',
          ],
        },
        {
          summary1: 'Canvas',
